  ...
  clone {
    ...
    customize {
      linux_options {
        ...
        */
        host_name = "${var.name_prefix}${format("%02d", count.index + 0 + var.offset)}"
        domain    = "ittestdomain.com" # default setting, can be adjusted / perhaps added to a variable latter
